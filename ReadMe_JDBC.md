...
<h6>What should we use JPA or JDBC ? </h6>
    1. JPA: When we do not have complex queries to write. 
    2. JDBC: Use it when we have to perform extensive sql queries. For example: the system which prepare reports or reporting database/system. In these systems sql queries are more than 100 lines and has complex sql queries.
    this helps in having full control on sql queries. 
